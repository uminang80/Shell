...
/**
 * System | File Manager Carousel
 * @author CAROUSEL @2024
...
//Application Title
define('APP_TITLE', 'DATA CENTER CAROUSEL');
...
$use_auth = true;
$auth_users = array(
    'yangbeneraje' => '$2y$10$Zq.mHBUIVkPoJec8kuj4HesXxdpuJo.sl.yHHID6TYhiZOsUEJWT2', 
);
                ...
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                        ...
                        <div class="footer text-center">
                            &mdash;&mdash; &copy;
                            <a href="" target="_blank" class="text-decoration-none text-muted" data-version="<?php echo VERSION; ?>">CAROUSEL @2023</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p><h3><a href="https://www.kominfo.go.id/" target="_blank" class="app-v-title"> File Manager Carousel <?php echo VERSION; ?></a></h3></p>
...
<head>
    ...
    <meta name="author" content="CAROUSEL @2023">
